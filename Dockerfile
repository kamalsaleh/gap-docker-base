...
# use Julia 1.8.2 until https://github.com/JuliaLang/julia/issues/47196 is fixed
RUN mkdir -p inst/julia-master && curl -L https://julialang-s3.julialang.org/bin/linux/x64/1.8/julia-1.8.2-linux-x86_64.tar.gz | tar -xvz --strip-components=1 -C inst/julia-master
